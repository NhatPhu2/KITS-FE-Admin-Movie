...
const TableListGenres = () => {

  const genres = useSelector((prop) => prop.genres);
  ...
  const getGenres = async (page) => {
    { genres.listGenres && setTotalPages(genres.listGenres.totalPage) }
    dispatch.genres.getPageGenres(page);
  }
                ...
                {genres.listGenres &&
                  genres.listGenres.map((el, i) => (
                    ...
                    >
                      ...
                      <TableCell align="center">{el.genresName}</TableCell>
...
export default TableListGenres;
