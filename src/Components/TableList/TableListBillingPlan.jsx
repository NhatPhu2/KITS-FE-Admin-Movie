...
const TableListBillingPlan = () => {
    ...
    const getBillingPlan = async (page) => {
        { billingPlans.listBillingPlan && setTotalPages(billingPlans.listBillingPlan.totalPage) }
        dispatch.billingPlan.getPageBillingPlan(page);
    }
            ...
            <Box sx={{ width: "100%" }}>
                <Paper sx={{ width: "100%", mb: 2 }}>
                    ...
                    <TableContainer>
                        ...
                        >
                            <EnhancedTableHead
                                rowCount={billingPlans.listBillingPlan && billingPlans.listBillingPlan.length}
                            />
                            <TableBody>
                                {billingPlans.listBillingPlan &&
                                    billingPlans.listBillingPlan.map((el, i) => (
                                        <TableRow
                                            sx={{ "&:last-child td, &:last-child th": { border: 0 } }} key={i}
                                        >
                                            <TableCell component="th" scope="row"></TableCell>
                                            <TableCell align="center">{el.id}</TableCell>
                                            <TableCell align="center">{el.billingPlanName}</TableCell>
                                            <TableCell align="center">{el.price}</TableCell>
                                            <TableCell align="center">{el.durationText}</TableCell>
...
export default TableListBillingPlan;
