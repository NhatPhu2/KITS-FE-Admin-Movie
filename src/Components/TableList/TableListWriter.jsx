...
const TableListWriter = () => {

  const writers = useSelector((prop) => prop.writer);
  const dispatch = useDispatch();
  useEffect(() => {
    getWriter(0)
  }, []);
  const [totalPages, setTotalPages] = useState(2);
  const getWriter = async (page) => {
    { writers.listWriter && setTotalPages(writers.listWriter.totalPage) }
    dispatch.writer.getPageWriter(page);
  }
      ...
      <Box sx={{ width: "100%" }}>
        <Paper sx={{ width: "100%", mb: 2 }}>
          ...
          <TableContainer>
            ...
            >
              <EnhancedTableHead
                rowCount={writers.listWriter && writers.listWriter.length}
              />
                ...
                {writers.listWriter &&
                  writers.listWriter.data.map((el, i) => (
                    ...
                    >
                      ...
                      <TableCell align="center">{el.writerName}</TableCell>
...
export default TableListWriter;
