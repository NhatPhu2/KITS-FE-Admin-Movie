...
const TableListCountry = () => {
    ...
    const getCountry = async (page) => {
        { countries.listCountry && setTotalPages(countries.listCountry.totalPage) }
        dispatch.country.getPageCountry(page);
    }
                                ...
                                {countries.listCountry &&
                                    countries.listCountry.data.map((el, i) => (
                                        ...
                                        >
                                            ...
                                            <TableCell align="center">{el.countryName}</TableCell>
